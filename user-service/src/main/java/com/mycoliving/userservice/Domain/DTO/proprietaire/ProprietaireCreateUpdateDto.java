...
public class ProprietaireCreateUpdateDto implements Serializable {
    ...
    public ProprietaireCreateUpdateDto(String email, String password, String nom, String prenom, String telephone, Integer age, String ville, Boolean verified, Set<Long> roleIds, Long profileId, List<Long> propertyIds) {
        this.email = email;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(email, password, nom, prenom, telephone, age, ville, verified, roleIds, profileId, propertyIds);
    }
